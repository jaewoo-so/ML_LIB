...
E:\01_PProj\ML_LIB\mllib\training.py in training_fixedTest(mode, model_generator, model_params, training_params, metric_func, X, y, X_test, nfold, nradom, verbose)
